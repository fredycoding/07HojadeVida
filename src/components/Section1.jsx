...
export const Section1 = () => {
  ...
  return (
    <div className='imagenpython animate__animated animate__fadeInDownBig'>
 
      <div className="w-full h-screen bg-no-repeat bg-cover bg-left bg-fixed">

        <div className='flex flex-col justify-center h-screen pl-20 md:pl-40 relative animate__animated animate__backInRight'>
