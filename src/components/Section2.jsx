  ...
  return (
    <div className='animate__animated animate__fadeInDownBig'>
      <div className="w-full h-screen bg-no-repeat bg-cover bg-left bg-fixed">
        <div className='flex flex-col justify-start md:justify-center pt-12 md:pt-20 h-screen pl-12 md:pl-40 relative animate__animated animate__backInRight'>
          ...
          <div className='md:w-1/4 text-1xl'>
            ...
            <p className='mt-1 text-slate-700'>Bogotá, Colombia</p>
            <p className='mt-1 text-slate-700'>(571) 456-7891</p>
            <p className='mt-1 text-slate-700'>micorreo@gmail.com</p>
          </div>
